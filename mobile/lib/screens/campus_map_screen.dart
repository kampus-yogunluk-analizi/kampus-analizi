...
class _CampusMapScreenState extends State<CampusMapScreen> {
  ...
  String currentLocation = 'Konum alınamadı';
  ...
  void connectWebSocket() {
    ...
    channel.stream.listen(
      (message) {
        ...
        setState(() {
          points = data
              .map(
                (item) =>
                    HeatmapPoint.fromJson(Map<String, dynamic>.from(item)),
              )
              .toList();
          isLoading = false;
        });
      ...
      onDone: () {
        debugPrint('WEBSOCKET BAĞLANTISI KAPANDI');
      },
    );
  }
